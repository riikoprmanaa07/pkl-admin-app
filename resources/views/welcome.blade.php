...
<body>
    ...
    <main>
        <section class="hero-section">
            <div class="container">
                <h1 class="hero-title">
                    Platform Manajemen Modern <br> untuk <span class="highlight">Proyek Anda</span>
                </h1>
                <p class="hero-subtitle">
                    Ini adalah kerangka awal yang kokoh untuk aplikasi Anda. Dibangun dengan Laravel, platform ini siap dikembangkan lebih lanjut sesuai kebutuhan spesifik tugas PKL Anda.
                </p>
